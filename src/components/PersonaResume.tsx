...
const PersonaResume: React.FC<Props> = ({ persona }) => {
  ...
  return (
    <li className="text-white bg-emerald-400 rounded-md">
      ...
      />
      <header
        className="py-1 px-3 bg-emerald-500 hover:bg-emerald-600 rounded-md flex justify-between items-center cursor-pointer"
      ...
      {isExpanded && (
        <div className="bg-emerald-400 rounded-b-md transition ease-in-out duration-300">
